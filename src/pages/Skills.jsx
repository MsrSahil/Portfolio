...
const Skills = () => {
  ...
  const skills = [
    ...
    {
      name: "JavaScript",
      icon: <DiJavascript size={40} className="text-yellow-400" />,
    ...
    {
      name: "HTML5",
      icon: <DiHtml5 size={40} className="text-orange-500" />,
    ...
    {
      name: "CSS3",
      icon: <DiCss3 size={40} className="text-blue-500" />,
      color: "text-blue-500",
      category: "Frontend",
      value: 97,
    },
    {
      name: "Bootstrap",
      icon: <FaBootstrap size={40} className="text-purple-400" />,
    ...
    {
      name: "Vite",
      icon: <SiVite size={40} className="text-purple-500" />,
  ...
  return (
    <section
      id="skills"
      className="relative w-full min-h-screen py-20 px-6 bg-[#2C313A] overflow-hidden"
    >
